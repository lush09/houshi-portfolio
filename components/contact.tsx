...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setSubmissionMessage({ type: 'success', text: "Message sent successfully! I'll get back to you soon." });
        setFormState({ name: "", email: "", message: "" });
      } else {
        setSubmissionMessage({ type: 'error', text: "Something went wrong. Please try again." });
      }
    } catch (error) {
      setSubmissionMessage({ type: 'error', text: "An error occurred. Please try again later." });
    } finally {
        ...
        <div ref={ref} className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-6">
              {contactInfo.map((item, index) => (
                ...
                >
                  <div className="bg-gray-800 p-3 rounded-full">{item.icon}</div>
                  <div>
              ...
              <Card className="bg-gray-800 border-gray-700">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-300 mb-6">
                    I'm currently open to new opportunities. If you want to discuss potential collaborations, feel free to reach out.
                  </p>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {submissionMessage && (
                <p className={`text-center ${submissionMessage.type === 'success' ? 'text-green-400' : 'text-red-400'}`}>
